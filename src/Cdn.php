...
class Cdn implements CdnInterface
{
     ...
     *
     * @internal param \SampleNinja\LaravelCdn\Repository $configurations
     */
    ...
    /**
     * Will be called from the SampleNinja\LaravelCdn\PushCommand class on Fire().
     */
    ...
    /**
     * Will be called from the SampleNinja\LaravelCdn\EmptyCommand class on Fire().
     */
